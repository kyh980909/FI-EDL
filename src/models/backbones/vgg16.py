...
Matches the I-EDL (Deng et al., 2023) and Re-EDL (Chen et al., 2024) paper
protocol for CIFAR-10 classification. Used by the old-cycle baseline
re-runs that align with the published comparison setup.
"""
