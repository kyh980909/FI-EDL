"""Protocols that plugin components (backbones, heads, losses, scores) must satisfy.

`lit_module` calls `assert_module_instance` after constructing each component so
registration errors fail fast at model build time.
"""
